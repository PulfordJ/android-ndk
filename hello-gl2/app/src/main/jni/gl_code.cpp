...
GLuint createProgram(const char* pVertexSource, const char* pFragmentSource) {
    ...
    if (!pixelShader) {
        LOGE("Could not load pixel shader:\n%s\n");
        return 0;
    }
...
bool setupGraphics(int width, int height)
{
    ...
    textureCordLocation = glGetAttribLocation(simpleCubeProgram, "vertexTextureCord");
    ...
    samplerLocation = glGetUniformLocation(simpleCubeProgram, "texture");
